...
# Banner
banner = ("""[bold red] ________  _______   _______   ________  ________ 
  /        \/       \\/       \ /    /   \/        \
[bold red] /        _/        //        //         /         /
 /       //         /        //         /         / 
[bold white]\_____// \___/____/\________/\___/____/\___/____/  

[italic cyan]Coded by MR Talha""")
...
def Main():
    ...
    try:
        Console(width=50).print(Panel("[italic white]Hlw This toll code by Bangladeshi expert Mr Talha this tolls run End Enjoy visit official website: teamcsb.coma :[italic green] Data/Contoh.jpg", title='😎', style='bold plum4'))
        file = Console().input("[bold white][[bold green]?[bold white]][bold white] Files : ")
        img = Open(file)["Gambar"]
        Console(width=50).print(Panel("[italic white]please wait", title='🙂', style='bold plum4'));time.sleep(2.5)
